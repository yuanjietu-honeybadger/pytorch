...
class CachingAutotuner(KernelInterface):
    ...
    def run(
        ...
        **kwargs,
        ...
        # set_allocator(), TritonBundler.put_winner(), combo/coordesc checks,
        # tuple(args) copy, and dump_launch checks.
        # Re-check profiler and debug mode every call so that enabling them
        # at runtime correctly falls back to the slow path.
