...
load_kernel_template = partial(load_template, package="torch._inductor.kernel")

load_fb_kernel_template = partial(
    load_template, package="torch._inductor.fb", subdir="tlx_templates"
)
